                        ...
                        <div className="">
                            { projectTecnology.map( (tecnology, index)=>{
                                <div className={index+"-"+id}>
                                    <img src={allTecnology.find( allTecnology => allTecnology.id === tecnology.idTecnology ).pothoSrc} alt="" className=""/>
                                    <p className="" >{allTecnology.find( allTecnology => allTecnology.id === tecnology.idTecnology ).name}</p>
                                </div>
                            } ) }
                        </div>
                    </div>
